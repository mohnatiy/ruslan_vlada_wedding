...
const photo1 = "../assets/photo1.jpg"; // Main wedding 
const photo2 = "../assets/photo2.jpg"; // Venue
const photo3 = "../assets/photo3.jpg"; // Style
const photo4 = "../assets/photo4.jpg"; // Flowers bg
const photo5 = "../assets/photo5.jpg"; // Couple intro
