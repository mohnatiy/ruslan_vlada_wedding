...
const photo1 = "./public/photo1.jpg"; // Main wedding 
const photo2 = "./public/photo2.jpg"; // Venue
const photo3 = "./public/photo3.jpg"; // Style
const photo4 = "./public/photo4.jpg"; // Flowers bg
const photo5 = "./public/photo5.jpg"; // Couple intro
